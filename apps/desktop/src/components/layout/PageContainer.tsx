...
export function PageContainer({ children, className, title, actions }: PageContainerProps) {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      >
        <div className="flex items-center gap-4 min-w-0 shrink-0" data-tauri-drag-region>
          {typeof title === 'string' ? (
        ...
        <div className="flex items-center gap-4 flex-1 justify-end min-w-0" data-tauri-drag-region>
          ...
          {/* Global Actions - Remove drag region to allow clicks */}
